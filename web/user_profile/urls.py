...
urlpatterns += [
    path('news-feed-article/', views.NewsFeedArticleListView.as_view(), name='news_feed_article'),
    path('news-feed-comment/', views.NewsFeedCommentListView.as_view(), name='news_feed_comment'),
    path('news-feed-followers/', views.NewsFeedFollowerListView.as_view(), name='news_feed_follower'),
